<!-- filepath: c:\xampp\htdocs\Student-Management-System-PHP-V2.0\Student-Management-System-PHP-V2.0\studentms\admin\view-single-notice.php -->
<?php
session_start();
...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
    ...
    if (isset($_GET['viewid'])) {
        ...
        $sql = "SELECT * FROM tblnotice WHERE ID = :notice_id";
                    ...
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="manage-notice.php">Manage Notices</a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if ($result) { ?>
                                        ...
                                        <?php if (!empty($result->NoticeImage)) { ?>
                                            ...
                                            <!--<?php
                                            if (!empty($result->NoticeImage)) {
                                                echo "Image Path: " . htmlentities($result->NoticeImage); // Debugging
                                            }
                                            ?>-->
                                        <?php } else { ?>
