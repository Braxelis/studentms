    ...
    if ($query->rowCount() > 0) {
        foreach ($results as $row) {
            ...
            <tr>
                ...
                <td>
                    <a href="view-public-notice.php?viewid=<?php echo htmlentities($row->ID); ?>" class="btn btn-primary btn-xs">View</a>
                    <a href="edit-public-notice-detail.php?editid=<?php echo htmlentities($row->ID); ?>" class="btn btn-info btn-xs">Edit</a>
                    <a href="manage-public-notice.php?delid=<?php echo htmlentities($row->ID); ?>" onclick="return confirm('Do you really want to delete this notice?');" class="btn btn-danger btn-xs">Delete</a>
                </td>
            </tr>
            <?php
            $cnt++;
