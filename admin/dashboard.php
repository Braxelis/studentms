...
<html lang="en">
  <head>
    ...
    <title>AlumniDocs|||Dashboard</title>
    <!-- plugins:css -->
...
?>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                            <?php 
                            $sql5 = "SELECT * from groups"; // Query to count groups
                            $query5 = $dbh->prepare($sql5);
                            $query5->execute();
                            $results5 = $query5->fetchAll(PDO::FETCH_OBJ);
                            $totgroups = $query5->rowCount();
                            ?>
                            <span class="report-title">Total Groups</span>
                            <h4><?php echo htmlentities($totgroups); ?></h4>
                            <a href="manage-groups.php"><span class="report-count"> View Groups</span></a>
                        </div>
...
?>
                          <span class="report-title">Total Documents </span>
                          <h4><?php echo htmlentities($totalhw);?></h4>
                          <a href="manage-homeworks.php"><span class="report-count"> View Documents</span></a>
                        </div>
                        <div class="inner-card-icon bg-success">
                          <i class="icon-doc"></i>
                        </div>
