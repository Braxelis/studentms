<!-- filepath: c:\xampp\htdocs\Student-Management-System-PHP-V2.0\Student-Management-System-PHP-V2.0\studentms\user\view-single-notice.php -->
<?php
session_start();
...
if (strlen($_SESSION['sturecmsstuid'] == 0)) {
    ...
    if (isset($_GET['nid'])) {
        $notice_id = intval($_GET['nid']);
        $sql = "SELECT * FROM tblnotice WHERE ID = :nid";
        $query = $dbh->prepare($sql);
        $query->bindParam(':nid', $notice_id, PDO::PARAM_INT);
        $query->execute();
...
<html lang="en">
<head>
    <title>View Single Notice</title>
                    ...
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="view-notice.php">Notices</a></li>
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p><strong>Message:</strong> <?php echo htmlentities($result->NoticeMsg); ?></p>
                                    ...
                                    <?php if (!empty($result->NoticeFile)) { ?>
                                        ...
                                        <a href="<?php echo htmlentities($result->NoticeFile); ?>" target="_blank">View File</a>
                                    <?php } else { ?>
